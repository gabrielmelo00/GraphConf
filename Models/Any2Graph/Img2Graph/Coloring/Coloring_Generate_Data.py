...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_size", type=int, default=10000, help="Number of test samples.")
    parser.add_argument("--valid_size", type=int, default=10000, help="Number of validation samples.")
